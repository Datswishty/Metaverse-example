...
interface LandInterface extends ethers.utils.Interface {
  functions: {
    ...
    "maxPlanetLands()": FunctionFragment;
    "mintLand(address,uint256,uint256,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "maxPlanetLands",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "LandMinted(uint256,uint256,address)": EventFragment;
...
export class Land extends BaseContract {
  ...
  functions: {
    ...
    maxPlanetLands(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "LandMinted(uint256,uint256,address)"(
      tokenId?: null,
      planetId?: null,
      owner?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber, string],
      { tokenId: BigNumber; planetId: BigNumber; owner: string }
    >;
  ...
  populateTransaction: {
    ...
    maxPlanetLands(overrides?: CallOverrides): Promise<PopulatedTransaction>;
