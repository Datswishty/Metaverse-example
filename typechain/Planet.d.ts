...
interface PlanetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintPlanet(address,uint256,string)": FunctionFragment;
  ...
  events: {
    ...
    "planetMinted(uint256,address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "planetMinted"): EventFragment;
}
...
export type planetMintedEvent = TypedEvent<
  [BigNumber, string] & { planetId: BigNumber; to: string }
>;

export class Planet extends BaseContract {
  ...
  filters: {
    ...
    "planetMinted(uint256,address)"(
      planetId?: null,
      to?: null
    ): TypedEventFilter<
      [BigNumber, string],
      { planetId: BigNumber; to: string }
    >;
