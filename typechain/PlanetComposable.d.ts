...
interface PlanetComposableInterface extends ethers.utils.Interface {
  functions: {
...
export class PlanetComposable extends BaseContract {
  ...
  interface: PlanetComposableInterface;
