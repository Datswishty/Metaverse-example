...
interface ScaleComposableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setStorageAddress(address)": FunctionFragment;
...
export class ScaleComposable extends BaseContract {
  ...
  interface: ScaleComposableInterface;
