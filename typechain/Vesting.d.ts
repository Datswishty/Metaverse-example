...
interface VestingInterface extends ethers.utils.Interface {
  functions: {
    ...
    "addressArray(address,uint256)": FunctionFragment;
...
export type NewBuyerEvent = TypedEvent<
  [string, BigNumber] & { buyer: string; valueToBuy: BigNumber }
>;
...
export class Vesting extends BaseContract {
  ...
  filters: {
    "NewBuyer(address,uint256)"(
      buyer?: string | null,
      valueToBuy?: BigNumberish | null
    ): TypedEventFilter<
      [string, BigNumber],
      { buyer: string; valueToBuy: BigNumber }
    >;
